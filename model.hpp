...
private:
    ...
    double m_length;                    // Taille du carré représentant le terrain (en km) l
    double m_distance;                  // Taille d'une case du terrain modélisé n
    ...
    std::unordered_map<std::size_t, std::uint8_t> m_fire_front; // c'est ca le dictionnaire
};
